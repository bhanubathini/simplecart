<?php 
	...
	if(isset($_POST['submitpage']))
	{
		addPage();	
		images($pageId);
		header('location:main-pages.php?msg=success');
	}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                        ...
                        <div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" id="pagesform" enctype="multipart/form-data">
										...
										<div class="control-group">
											<label class="control-label" for="catsel">Parent Category</label>
											<div class="controls">
												<select tabindex="1" data-placeholder="Select category.." class="span8" name="catsel" id="catsel">
													<option value="0">Select category..</option>
                                                    <?php
														require_once("../api.php");
														$api = new API;
														$api->dbConnect();
														$getQuery = mysqli_query($api->db, "SELECT * FROM n_category ORDER BY cat_id") or die(mysqli_error());
                                        ...
                                        <div class="control-group">
											<label class="control-label" for="subcatsel">Sub Category</label>
											<div class="controls">
												<select tabindex="1" data-placeholder="Select sub category.." class="span8" id="subcatsel" name="subcatsel" disabled>
													<option value="0">Select sub category..</option>
												</select>
											</div><span class="help-inline" id="subcategoryt"></span>
										</div>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">TricksTown.com
		</div>
	</div>
