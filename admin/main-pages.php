					...
					<div class="content">
						...
						?>
                        	<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
										<strong>Soory!</strong> You have entered duplicate values. Please try again 
							</div>
                        <?php
							}
						?>
									   ...
									   ?>
                                        ...
                                        <!-- <div class="control-group">
                                         ...
                                         <div class="control-group">
											...
											<div class="controls">
                                            <textarea name="descriptioninput" id="descriptioninput" class="span8"></textarea>
											</div>
										</div>
										<div class="control-group">
											<div class="controls">
...
<script>
	...
	{
		$('.youtubediv').html('<div class="controls"><input type="text" id="" name="file" class="span8" placeholder="Youtube url">											</div><br>');
	});
