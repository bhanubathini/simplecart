...
function editService()
{
	...
	$ins = mysqli_query($api->db, "UPDATE n_services SET ser_title='$titleinput', ser_cat='$categoryinput', ser_front_img='$frontimgdir', ser_back_img='$inimgdir', ser_description='$descriptioninput' WHERE ser_id=$serid")  or die(mysqli_error($api->db));
}
//GET SERVICE
