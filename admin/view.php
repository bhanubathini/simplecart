                                            ...
                                            <tr class="unread">
                                               ...
                                               <!-- <td class="cell-title">
                                                ...
                                                <td class="cell-icon hidden-phone hidden-tablet">
                                                    <!--<a href="p.php?id=<?php echo $prow['pg_id']; ?>" class="btn btn-primary">View</a>-->
                                                    <a href="pedit.php?id=<?php echo $prow['pg_id']; ?>" class="btn btn-primary">Edit</a>
                                        <a href="pdelete.php?id=<?php echo $prow['pg_id']; ?>" class="btn btn-primary deleteNaani">Delete</a>
                                                </td>
